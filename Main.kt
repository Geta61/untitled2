...
fun main() {
    //2.запись и чтение с помощью встроенных методов
    val task = File("C:\\Users\\asus\\IdeaProjects\\lab2\\src\\main\\task\\task.txt")
    val readFile = task.readText() //чтение файла
    ...
    //1. чтение и запись с помощью Input- и OutputStream
    var i:Int
